...
import 'package:listview_example_ios/sub/firstPage.dart';
import 'package:listview_example_ios/sub/secondPage.dart';
...
class _MyHomePageState extends State<MyHomePage>
  ...
  List<Animal> animalList = new List.empty(
      growable: true); //List.empty 생성(비어있음) growable는 증가할 수 있음을 알려줌
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
